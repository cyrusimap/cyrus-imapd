 ...
 * gcc -I.. -I ../lib ../lib/.libs/util.o ../lib/.libs/xmalloc.o
 * ../lib/.libs/map_shared.o ../lib/.libs/retry.o ../lib/.libs/assert.o test3.c
 * -lz -lpcre2-posix
 */
#include <assert.h>
#include <stdio.h>
...
int main(int argc, const char **argv)
{
    ...
    for (i = 1; i < argc; i++) {
        ...
        if (0 == r) {
            ...
            fprintf(
                stderr, "error: ptsmodule_standard_root_dn returned %i\n", r);
            errors++;
        }
    }

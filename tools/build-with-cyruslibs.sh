...
LDFLAGS="-L$PREFIX/lib/x86_64-linux-gnu -L$PREFIX/lib -Wl,-rpath,$PREFIX/lib/x86_64-linux-gnu -Wl,-rpath,$PREFIX/lib"
PKG_CONFIG_PATH="$PREFIX/lib/x86_64-linux-gnu/pkgconfig:$PREFIX/lib/pkgconfig:\$PKG_CONFIG_PATH"
CFLAGS="-g -fPIC -W -Wall -Wextra"
autoreconf -v -i

...
export CFLAGS="$CYRUS_SAN_FLAGS -fno-omit-frame-pointer -ggdb -fPIC -W -Wall -Wextra -Werror -Wwrite-strings"
export CXXFLAGS="$CYRUS_SAN_FLAGS -fno-omit-frame-pointer -ggdb -fPIC -W -Wall -Wextra -Werror"

...
<sup> stable(3.8): </sup>[![Build Status:3.8](https://api.travis-ci.com/cyrusimap/cyrus-imapd.svg?branch=cyrus-imapd-3.4)](https://travis-ci.com/cyrusimap/cyrus-imapd)

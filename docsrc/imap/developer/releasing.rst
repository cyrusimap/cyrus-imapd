...
7. If this is an alpha/beta/rc release, click the "This is a pre-release"
   checkbox
8. If this *isn't* a pre-release, then *only* if this is a release of the
   latest series of Cyrus, click the "Set as the latest release" checkbox.
   In other words, if the latest stable release is 3.10.4 and you're releasing
   3.10.5, click "Set as the latest release".  If you're releasing 3.8.9,
   don't.

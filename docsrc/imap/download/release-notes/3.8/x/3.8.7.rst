...
===============================
Cyrus IMAP 3.8.7 Release Notes
===============================

Download from GitHub:

    *   https://github.com/cyrusimap/cyrus-imapd/releases/download/cyrus-imapd-3.8.7/cyrus-imapd-3.8.7.tar.gz
    *   https://github.com/cyrusimap/cyrus-imapd/releases/download/cyrus-imapd-3.8.7/cyrus-imapd-3.8.7.tar.gz.sig

.. _relnotes-3.8.7-changes:
...
* Fixed: :issue:`4566`: treat valgrind errors during unit tests as failures

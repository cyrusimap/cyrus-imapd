...
Download from GitHub:
    ...
    *   https://github.com/cyrusimap/cyrus-imapd/releases/download/cyrus-imapd-3.6.0-beta2/cyrus-imapd-3.6.0-beta2.tar.gz
    *   https://github.com/cyrusimap/cyrus-imapd/releases/download/cyrus-imapd-3.6.0-beta2/cyrus-imapd-3.6.0-beta2.tar.gz.sig

.. _relnotes-3.6.0-beta2-changes:
...
* Mailboxes and user metadata directories are now organised on disk by UUID
  rather than by mailbox name.  See :ref:`relnotes_3.6.0-beta2_storage_changes` below.
...
.. _relnotes_3.6.0-beta2_storage_changes:

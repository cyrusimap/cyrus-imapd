...
Download from GitHub:
    ...
    *   https://github.com/cyrusimap/cyrus-imapd/releases/download/cyrus-imapd-3.12.4/cyrus-imapd-3.12.4.tar.gz
    *   https://github.com/cyrusimap/cyrus-imapd/releases/download/cyrus-imapd-3.12.4/cyrus-imapd-3.12.4.tar.gz.sig

.. _relnotes-3.12.4-changes:
...
* Fixed: :issue:`6334`: JMAP ``CalendarEvent/set`` crash when
  ``participants.sendTo`` malformed

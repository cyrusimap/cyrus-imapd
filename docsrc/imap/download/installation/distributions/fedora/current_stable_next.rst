.. _imap-installation-fedora-current-stable-next:

Installation of Cyrus IMAP |imap_current_stable_next_version| on Fedora
=======================================================================

.. NOTE::

    Packages for Cyrus IMAP version |imap_current_stable_next_version|

...
# documentation.
html_theme_options = { 'github_version': 'cyrus-imapd-3.8'}
...
rst_prolog = """
.. |imap_last_stable_version| replace:: 3.6.0
.. |imap_last_stable_branch| replace:: `cyrus-imapd-3.6`
.. |imap_current_stable_version| replace:: 3.8.0-alpha0
...
.. |imap_stable_release_notes| raw:: html
    ...
    <a href="3.8/x/3.8.0-alpha0.html">3.8.0-alpha0</a>

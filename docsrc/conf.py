...
man_pages = [
        ...
        (
            'imap/reference/manpages/systemcommands/cyr_userseen',
            'cyr_userseen',
            u'Cyrus IMAP Documentation',
            [
                    u'The Cyrus Team',
...
rst_prolog = """
.. |imap_last_stable_version| replace:: 2.5.10
.. |imap_last_stable_branch| replace:: `cyrus-imapd-2.5`
.. |imap_current_stable_version| replace:: 3.0.1
...
.. |imap_stable_release_notes| raw:: html
    ...
    <a href="3.0/x/3.0.1.html">3.0.1</a>

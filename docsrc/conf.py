...
project = "Cyrus IMAP"
copyright = "1993–%s, The Cyrus Team" % datetime.date.today().year
...
latex_documents = [
    ("index", "Cyrus.tex", "Cyrus Documentation", "The Cyrus Team", "manual"),
]
...
epub_title = "Cyrus"
epub_author = "The Cyrus Team"
epub_publisher = "The Cyrus Team"
epub_copyright = "2014, The Cyrus Team"
...
rst_prolog = """
.. |imap_last_stable_version| replace:: 3.10.4
...
.. |imap_stable_release_notes| raw:: html
    ...
    <a href="3.12/x/3.12.4.html">3.12.4</a>

.. |imap_development_release_notes| raw:: html

    <a href="https://www.cyrusimap.org/dev/imap/download/release-notes/3.13/x/3.13.7.html">3.13.7</a>

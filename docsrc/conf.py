...
html_context = {
  ...
  "github_version": "cyrus-imapd-3.2",
  "conf_py_path": "/docsrc/",
...
# documentation.
html_theme_options = { 'travis_version': 'cyrus-imapd-3.2'}
...
.. |imap_current_stable_version| replace:: 3.2.0-beta2
...
.. |imap_development_release_notes| raw:: html
    ...
    <a href="3.1/x/3.1.9.html">3.1.9</a>

...
# documentation.
html_theme_options = { 'github_version': 'cyrus-imapd-3.12'}
...
rst_prolog = """
.. |imap_last_stable_version| replace:: 3.10.0
.. |imap_last_stable_branch| replace:: `cyrus-imapd-3.8`
.. |imap_current_stable_version| replace:: 3.12.0-alpha0
...
.. |imap_stable_release_notes| raw:: html
    ...
    <a href="3.12/x/3.12.0-alpha0.html">3.12.0-alpha0</a>

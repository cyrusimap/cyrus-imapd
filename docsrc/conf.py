...
rst_prolog = """
.. |imap_last_stable_version| replace:: 3.2.5
.. |imap_last_stable_branch| replace:: `cyrus-imapd-3.2`
.. |imap_current_stable_version| replace:: 3.4.0-alpha0
...
.. |imap_stable_release_notes| raw:: html
    ...
    <a href="3.4/x/3.4.0-alpha0.html">3.4.0-alpha0</a>

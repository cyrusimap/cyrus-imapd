...
Download from GitHub:
    ...
    *   https://github.com/cyrusimap/cyrus-imapd/releases/download/cyrus-imapd-3.0.0-beta5/cyrus-imapd-3.0.0-beta5.tar.gz
    *   https://github.com/cyrusimap/cyrus-imapd/releases/download/cyrus-imapd-3.0.0-beta5/cyrus-imapd-3.0.0-beta5.tar.gz.sig

#!/usr/bin/perl
# Cassandane::TestSuite::CassMeta: Cassandane meta-tests that need Cyrus
# (as distinct from Cassandane::TestSuite::Cassandane::*, which don't need Cyrus)
# SPDX-License-Identifier: BSD-3-Clause-CMU
# See COPYING file at the root of the distribution for more details.

package Cassandane::TestSuite::CassMeta;
use strict;
use warnings;
use Data::Dumper;

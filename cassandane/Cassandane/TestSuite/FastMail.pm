...
package Cassandane::TestSuite::FastMail;
use strict;
use warnings;
use DateTime;
use JSON::XS;
...
sub new
{
    ...
    $config->set(caldav_realm => 'Cassandane',
                 ...
                 lmtp_exclude_specialuse => '\XChats \XTemplates \XNotes \Drafts \Scheduled \Snoozed \Memos',
                 ...
                 specialuse_extra => '\\XChats \\XTemplates \\XNotes \\Memos',
                 statuscache => 'on',
...
package Cassandane::TestSuite::FastMail::BackupLogger {
    sub log
    {
        my (undef, $msg) = @_;
        if (ref $msg eq 'ARRAY') {
...
sub _backup_dirs
{
    ...
    $Cyrus::Backup::LOGGER_CB = sub { 'Cassandane::TestSuite::FastMail::BackupLogger' }

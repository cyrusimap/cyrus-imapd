/* netnews/readconfig.c - code for reading expire.ctl files */
/* SPDX-License-Identifier: BSD-3-Clause-CMU */
/* See COPYING file at the root of the distribution for more details. */
/* The code for reading expire.ctl files (most of this file) was borrowed from
 * innd Minor modifications to that code were made.  That source file was:
 *
